...
import 'package:car_reception_flutter/common/api_factory/models/base_list.dart';
...
import 'package:car_reception_flutter/common/config/app_images.dart';
...
handleApiError(errorMessage) {
  showSnackBar(backgroundColor: Colors.red, message: errorMessage);
}

showWarning(message) {
  showSnackBar(backgroundColor: Colors.red, message: message);
}
...
typedef OnItemsSelected = Function(BaseListModel data);
typedef OnMultiItemSelected = Function(List<BaseListModel> data);
typedef OnFilterSelected = Function(String salary);
